...
public class DataModelRepository {
  ...
  private void addDataTypeQualifier(PropertyRange datatype, BindingSet bs) {
    ...
    if (bs.getValue("qualifierunit") != null) {
      qualifier.setUnit(TTIriRef.iri(bs.getValue("qualifierunit").stringValue()));
    }
  }
  ...
  private String getPropertysql() {
    return """
      ...
      ?pattern ?unit ?unitName
      ?datatypeQualifier ?qualifierOrder ?qualifierName ?qualifierPattern ?qualifierunit ?qualifierunitName
      ...
      ?comment ?propertyDefinition ?units ?unitsName ?operator ?operatorName ?isRelativeValue
      {
         ...
         optional {?property sh:group ?group.
          ...
          optional {
                  ...
                  optional { ?datatype im:unit ?unit.
                  ...
                  optional { ?datatypeQualifier im:units ?qualifierunit.
                  ?qualifierunit rdfs:label ?qualifierunitName}
                      }
                      }
         optional {
