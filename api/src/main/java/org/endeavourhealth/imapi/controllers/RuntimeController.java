...
import org.endeavourhealth.imapi.logic.service.RuntimeService;
...
@CrossOrigin(origins = "*")
@Api(value="RuntimeController")
@SwaggerDefinition(tags = {
    @Tag(name = "Runtime Controller", description = "Runtime API endpoint (v1 backwards compatibility")
})
public class RuntimeController {
    ...
    public String getCodeForEntityDbid(@RequestParam("dbid") Integer dbid) throws SQLException {
