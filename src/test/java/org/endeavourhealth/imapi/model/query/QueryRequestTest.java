...
//    Query query = queryService.describeQuery(queryIri, DisplayMode.LOGICAL, GraphVocab.SMARTLIFE);
...
//
//    Query sameQuery = queryService.describeQuery(queryIri, DisplayMode.LOGICAL, GraphVocab.SMARTLIFE);
...
//    Query diffQuery = queryService.describeQuery(diffIri, DisplayMode.LOGICAL, GraphVocab.IM);
