...
public class CodeGenController {
  ...
  public HttpEntity<Object> generateCode(HttpServletRequest request,
                                         ...
                                         @Parameter(description = "The graphdb graph the data is stored under") @RequestParam(name = "graph", defaultValue = GRAPH.IM) String graph) throws IOException {
  ...
  public String generateCodePreview(HttpServletRequest request,
                                    ...
                                    @Parameter(description = "The graphdb graph the data is stored under") @RequestParam(name = "graph", defaultValue = GRAPH.IM) String graph
  ) throws IOException {
    try (MetricsTimer t = MetricsHelper.recordTime("API.CodeGen.GenerateCode.GET")) {
