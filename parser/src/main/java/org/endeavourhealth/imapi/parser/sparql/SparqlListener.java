...
public interface SparqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#filter_}.
	 * @param ctx the parse tree
	 */
	void enterFilter_(SparqlParser.Filter_Context ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#filter_}.
	 * @param ctx the parse tree
	 */
	void exitFilter_(SparqlParser.Filter_Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#object_}.
	 * @param ctx the parse tree
	 */
	void enterObject_(SparqlParser.Object_Context ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#object_}.
	 * @param ctx the parse tree
	 */
	void exitObject_(SparqlParser.Object_Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#var_}.
	 * @param ctx the parse tree
	 */
	void enterVar_(SparqlParser.Var_Context ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#var_}.
	 * @param ctx the parse tree
	 */
	void exitVar_(SparqlParser.Var_Context ctx);
	/**
