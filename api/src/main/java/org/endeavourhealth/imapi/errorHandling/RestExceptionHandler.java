...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleUncaughtException(Exception ex) {
        String error = "Unhandled server error";
    ...
    @ExceptionHandler(EntityNotFoundException.class) protected ResponseEntity<Object> handleEntityNotFound(EntityNotFoundException ex) {
    ...
    protected ResponseEntity<Object> handleDataFormatException(UnknownFormatConversionException ex) {
        return buildResponseEntity(new ApiError(BAD_REQUEST, "Invalid ECL format", ex));
    }
