...
class TTToStringTest {
  ...
  public TTArray getTestArray() {
    return new TTArray()
      .add(new TTIriRefExtended("http://snomed.info/sct#128084001", "Duane's syndrome, type 3 (disorder)"))
      .add(new TTIriRefExtended("http://snomed.info/sct#298382003", "Scoliosis deformity of spine (disorder)"))
      .add(new TTIriRefExtended("http://snomed.info/sct#82354003", "Multiple system malformation syndrome (disorder)"));
  }
  ...
  public TTBundle getTestBundle() {
    return new TTBundle()
      .addPredicate(EnumUtils.asIri(ImVocab. IS_A))
      .addPredicate(EnumUtils.asIri(ImVocab. ROLE_GROUP))
      .addPredicate(EnumUtils.asIri(OwlVocab.EQUIVALENT_CLASS))
      .addPredicate(EnumUtils.asIri(OwlVocab.ON_PROPERTY))
      .addPredicate(EnumUtils.asIri(RdfVocab.TYPE))
        ...
        .set(EnumUtils.asIri(RdfsVocab.SUBCLASS_OF), new TTArray()
          .add(new TTNode()
            .set(EnumUtils.asIri(OwlVocab.INTERSECTION_OF), new TTArray()
              ...
              .add(new TTIriRefExtended("http://snomed.info/sct#298382003", "Scoliosis deformity of spine (disorder)"))
              .add(new TTIriRefExtended("http://snomed.info/sct#82354003", "Multiple system malformation syndrome (disorder)"))
              .add(new TTIriRefExtended("http://snomed.info/sct#85995004", "Autosomal recessive hereditary disorder (disorder)"))
              .add(new TTNode()
                .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTNode()
                  .set(EnumUtils.asIri(OwlVocab.INTERSECTION_OF), new TTArray()
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#31739005", "Lateral abnormal curvature (morphologic abnormality)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#116676008", "Associated morphology (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#289959001", "Musculoskeletal structure of spine (body structure)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#363698007", "Finding site (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#308490002", "Pathological developmental process (qualifier value)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#370135005", "Pathological process (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                  )
                )
                .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://endhealth.info/im#roleGroup", "role group"))
                .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
              )
              .add(new TTNode()
                .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTNode()
                  .set(EnumUtils.asIri(OwlVocab.INTERSECTION_OF), new TTArray()
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#49755003", "Morphologically abnormal structure (morphologic abnormality)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#116676008", "Associated morphology (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#255399007", "Congenital (qualifier value)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#246454002", "Occurrence (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                    .add(new TTNode()
                      .set(EnumUtils.asIri(OwlVocab.SOME_VALUES_FROM), new TTIriRefExtended("http://snomed.info/sct#127954009", "Skeletal muscle structure (body structure)"))
                      .set(EnumUtils.asIri(OwlVocab.ON_PROPERTY), new TTIriRefExtended("http://snomed.info/sct#363698007", "Finding site (attribute)"))
                      .set(EnumUtils.asIri(RdfVocab.TYPE), new TTIriRefExtended("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                    )
                    .add(new TTNode()
