...
public class TestHelper {
  ...
  public static void checkEntity(TTNode entity) {
    ...
    assertEquals("Partial amputation of toe of left foot", entity
      .getAsLiteral(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfsVocab.LABEL))
      .getValue()
    );

    // Type(s)
    assertEquals(1, entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfVocab.TYPE)).size());
    assertTrue(entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfVocab.TYPE)).get(0).isIriRef());
    assertEquals(TTIriRefExtensionsKt.iri(new TTIriRef(), ImVocab.CONCEPT), entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfVocab.TYPE)).get(0).asIriRef());

    // Is A(s)
    assertEquals(2, entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), ImVocab.IS_A)).size());
    assertEquals(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#371186005", "Amputation of toe (procedure)"), entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), ImVocab.
      IS_A)).get(0).asIriRef());
    assertEquals(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#732214009", "Amputation of left lower limb"), entity.get(TTIriRefExtensionsKt.iri(new TTIriRef(), ImVocab.
      IS_A)).get(1).asIriRef());
    ...
    assertEquals(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#129309007", "Amputation - action"), roleGroup.get(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#260686004", "Method")).asIriRef());

    assertTrue(roleGroup.has(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#405813007", "Procedure site - Direct")));
    assertTrue(roleGroup.get(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#405813007", "Procedure site - Direct")).isIriRef());
    assertEquals(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#732939008", "Part of toe of left foot"), roleGroup.get(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://snomed.info/sct#405813007", "Procedure site - Direct")).asIriRef());
  }
}
