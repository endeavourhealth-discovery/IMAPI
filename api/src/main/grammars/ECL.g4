...
subrefinement : compoundattributeset | eclattributegroup | refinementgroup;
...
eclattribute : cardinality? (reverseflag ws)? eclattributename ws ((expressioncomparisonoperator ws (subexpressionconstraint | bracketcompoundexpressionconstraint)) | (numericcomparisonoperator ws POUND numericvalue) | (stringcomparisonoperator ws qm stringvalue qm));
