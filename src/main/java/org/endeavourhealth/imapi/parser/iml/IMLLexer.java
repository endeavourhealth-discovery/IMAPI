...
public class IMLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DEFINE", "AS", "MATCH", "FROM", "EITHER", "OR", "AND", "EXCLUDE", "IF", 
			"OF", "IS", "IN", "ON", "BETWEEN", "WITH", "WHERE", "OPEN_BRACE", "CLOSE_BRACE", 
			"OPEN_PAREN", "CLOSE_PAREN", "ARROW", "COMMA", "GT", "GTE", "LT", "LTE", 
			"EQ", "NEQ", "IDENTIFIER", "NUMBER", "WS", "COMMENT", "BLOCK_COMMENT", 
