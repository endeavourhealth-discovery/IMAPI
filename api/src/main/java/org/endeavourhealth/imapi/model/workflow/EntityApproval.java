...
public class EntityApproval extends Task {
  ...
  public EntityApproval(TTIriRef id, TaskType type, String createdBy, String assignedTo, TaskState state, LocalDateTime dateCreated, List<TaskHistory> history, String hostUrl, ApprovalType approvalType) {
