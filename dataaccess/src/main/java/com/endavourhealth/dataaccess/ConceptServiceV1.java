...
@Component
@Qualifier("ConceptServiceV1")
public class ConceptServiceV1 implements IConceptService {
	
	private static final Logger LOG = LoggerFactory.getLogger(ConceptServiceV1.class);
