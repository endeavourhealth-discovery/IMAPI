...
public class EqdToQuery {
	...
	public void convertReport(EQDOCReport eqReport, Query qry,TTDocument document,
		...
		if (eqReport.getFolder()!=null)
			qry.addFolder(TTIriRef.iri("urn:uuid:"+ eqReport.getFolder()));
		if (eqReport.getCreationTime()!=null)
			setProvenance(qry.getIri(), eqReport.getCreationTime().toString(),null);
