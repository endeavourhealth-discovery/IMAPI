...
public class ZFhirMapperAll {
    public static void main(String[] argv) throws Exception {
        ...
        new ZFhirMapperEncounter()
            .execute(argv[0] + "enc_1.txt", argv[1] + "enc1_")
            .execute(argv[0] + "enc_2.txt", argv[1] + "enc2_")
            .execute(argv[0] + "enc_3.txt", argv[1] + "enc3_");
        ...
        new ZFhirMapperObservation()
            .execute(argv[0] + "obs_1.txt", argv[1] + "obs1_")
            .execute(argv[0] + "obs_2.txt", argv[1] + "obs2_")
            .execute(argv[0] + "obs_3.txt", argv[1] + "obs3_")
            .execute(argv[0] + "obs_4.txt", argv[1] + "obs4_")
            .execute(argv[0] + "obs_5.txt", argv[1] + "obs5_")
            .execute(argv[0] + "obs_6.txt", argv[1] + "obs6_")
            .execute(argv[0] + "full_bp.txt", argv[1] + "fullbp_")
            .execute(argv[0] + "individual_bp.txt", argv[1] + "individualbp_");
    }
}
