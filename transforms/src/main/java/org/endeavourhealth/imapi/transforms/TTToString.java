...
public class TTToString {
    ...
    public static String ttValueToString(TTValue node, String previousType, Map<String, String> iriMap, int indent, boolean withHyperlinks, List<String> blockedIris) {
        if (node.isIriRef()) {
            ...
            return ttArrayToString(node.asArray(), indent, withHyperlinks, iriMap, blockedIris);
        } else {
    ...
    private static String processNode(String key, TTValue value, String result, int indent, Map<String, String> iriMap, String pad, String prefix, String suffix, boolean group, boolean last, boolean withHyperlinks, List<String> blockedIris) {
        if (value.isIriRef()) {
