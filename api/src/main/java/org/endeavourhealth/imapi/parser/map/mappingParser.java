...
public class mappingParser extends Parser {
  ...
  public static class StructureMapContext extends ParserRuleContext {
    ...
    public TerminalNode EOF() {
      return getToken(mappingParser.EOF, 0);
    }
  ...
  public static class UrlContext extends ParserRuleContext {
    public TerminalNode DELIMITEDIDENTIFIER() {
      return getToken(mappingParser.DELIMITEDIDENTIFIER, 0);
    }
  ...
  public static class IdentifierContext extends ParserRuleContext {
    public TerminalNode IDENTIFIER() {
      return getToken(mappingParser.IDENTIFIER, 0);
    }
  ...
  public static class SourceTypeContext extends ParserRuleContext {
    ...
    public TerminalNode INTEGER() {
      return getToken(mappingParser.INTEGER, 0);
    }
  ...
  public static class LiteralContext extends ParserRuleContext {
    ...
    public TerminalNode NUMBER() {
      return getToken(mappingParser.NUMBER, 0);
    }

    public TerminalNode STRING() {
      return getToken(mappingParser.STRING, 0);
    }

    public TerminalNode DATETIME() {
      return getToken(mappingParser.DATETIME, 0);
    }

    public TerminalNode DATE() {
      return getToken(mappingParser.DATE, 0);
    }

    public TerminalNode TIME() {
      return getToken(mappingParser.TIME, 0);
    }

    public TerminalNode BOOL() {
      return getToken(mappingParser.BOOL, 0);
    }
