...
public interface SparqlVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by {@link SparqlParser#filter_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitFilter_(SparqlParser.Filter_Context ctx);
  ...
  /**
   * Visit a parse tree produced by {@link SparqlParser#object_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitObject_(SparqlParser.Object_Context ctx);
  ...
  /**
   * Visit a parse tree produced by {@link SparqlParser#var_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitVar_(SparqlParser.Var_Context ctx);
