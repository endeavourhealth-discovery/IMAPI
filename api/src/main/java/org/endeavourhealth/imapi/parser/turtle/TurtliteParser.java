...
public class TurtliteParser extends Parser {
  ...
  public static class PrefixIDContext extends ParserRuleContext {
    public TerminalNode PNAME_NS() {
      return getToken(TurtliteParser.PNAME_NS, 0);
    }

    public TerminalNode IRIREF() {
      return getToken(TurtliteParser.IRIREF, 0);
    }
  ...
  public static class PredicateObjectListContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_predicateObjectList;
    }
    ...
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof TurtliteVisitor)
        return ((TurtliteVisitor<? extends T>) visitor).visitPredicateObjectList(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class SubjectContext extends ParserRuleContext {
    ...
    public TerminalNode BlankNode() {
      return getToken(TurtliteParser.BlankNode, 0);
    }
  ...
  public static class LiteralContext extends ParserRuleContext {
    ...
    public TerminalNode NumericLiteral() {
      return getToken(TurtliteParser.NumericLiteral, 0);
    }

    public TerminalNode BooleanLiteral() {
      return getToken(TurtliteParser.BooleanLiteral, 0);
    }
  ...
  public static class BlankNodePropertyListContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof TurtliteVisitor)
        return ((TurtliteVisitor<? extends T>) visitor).visitBlankNodePropertyList(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class RdfLiteralContext extends ParserRuleContext {
    public TerminalNode String() {
      return getToken(TurtliteParser.String, 0);
    }

    public TerminalNode LANGTAG() {
      return getToken(TurtliteParser.LANGTAG, 0);
    }
  ...
  public static class CommentContext extends ParserRuleContext {
    public TerminalNode LINE_COMMENT() {
      return getToken(TurtliteParser.LINE_COMMENT, 0);
    }
  ...
  public static class IriContext extends ParserRuleContext {
    ...
    public TerminalNode PrefixedName() {
      return getToken(TurtliteParser.PrefixedName, 0);
    }
