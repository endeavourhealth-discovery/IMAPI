...
class CodeGenJavaTest {
  ...
  void getDataType_ShouldReturnXsdType() {
    CodeGenJava codeGen = new CodeGenJava();
    assertEquals("String", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://www.w3.org/2001/XMLSchema#string"), false, false));
    assertEquals("Integer", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://www.w3.org/2001/XMLSchema#integer"), false, false));
  }

  @Test
  void getDataType_ShouldReturnUUIDForDataModel() {
    CodeGenJava codeGen = new CodeGenJava();
    assertEquals("UUID", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://endhealth.info/im#SomeModel"), true, false));
  }

  @Test
  void getDataType_ShouldReturnList() {
    CodeGenJava codeGen = new CodeGenJava();
    assertEquals("List<String>", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://www.w3.org/2001/XMLSchema#string"), false, true));
  }

  @Test
  void getDataType_ShouldHandleSpecialIris() {
    CodeGenJava codeGen = new CodeGenJava();
    assertEquals("String", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://endhealth.info/im#Status"), false, false));
    assertEquals("PartialDateTime", codeGen.getDataType(TTIriRefExtensionsKt.iri(new TTIriRef(), "http://endhealth.info/im#DateTime"), false, false));
  }
