...
class TTToStringTest {
    ...
    public TTNode getTestNode() {
        return new TTNode().set(iri(OWL.INTERSECTION_OF, "intersectionOf"), getTestArray());
    }

    public TTBundle getTestBundle() {
        return new TTBundle()
                .addPredicate(iri(IM.IS_A, "isA"))
                .addPredicate(iri(IM.ROLE_GROUP, "roleGroup"))
                .addPredicate(iri(OWL.EQUIVALENT_CLASS, "equivalentClass"))
                .addPredicate(iri(OWL.ON_PROPERTY, "onProperty"))
                .addPredicate(iri(RDF.TYPE, "type"))
                .addPredicate(iri(RDFS.SUBCLASS_OF, "subClassOf"))
                .addPredicate(iri(OWL.INTERSECTION_OF, "intersectionOf"))
                .addPredicate(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"))
                .setEntity(new TTEntity()
                        .set(iri(RDFS.SUBCLASS_OF, "subClassOf"), new TTArray()
                                .add(new TTNode()
                                        .set(iri(OWL.INTERSECTION_OF, "intersectionOf"), new TTArray()
                                                .add(iri("http://snomed.info/sct#128084001", "Duane's syndrome, type 3 (disorder)"))
                                                .add(iri("http://snomed.info/sct#298382003", "Scoliosis deformity of spine (disorder)"))
                                                .add(iri("http://snomed.info/sct#82354003", "Multiple system malformation syndrome (disorder)"))
                                                .add(iri("http://snomed.info/sct#85995004", "Autosomal recessive hereditary disorder (disorder)"))
                                                .add(new TTNode()
                                                        .set(iri(OWL.SOME_VALUES_FROM), new TTNode()
                                                                .set(iri(OWL.INTERSECTION_OF), new TTArray()
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#31739005", "Lateral abnormal curvature (morphologic abnormality)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#116676008", "Associated morphology (attribute)"))
                                                                                .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#289959001", "Musculoskeletal structure of spine (body structure)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#363698007", "Finding site (attribute)"))
                                                                                .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#308490002", "Pathological developmental process (qualifier value)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#370135005", "Pathological process (attribute)"))
                                                                                .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                )
                                                        )
                                                        .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://endhealth.info/im#roleGroup", "role group"))
                                                        .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                )
                                                .add(new TTNode()
                                                        .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), new TTNode()
                                                                .set(iri(OWL.INTERSECTION_OF, "intersectionOf"), new TTArray()
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#49755003", "Morphologically abnormal structure (morphologic abnormality)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#116676008", "Associated morphology (attribute)"))
                                                                                .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#255399007", "Congenital (qualifier value)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#246454002", "Occurrence (attribute)"))
                                                                                .set(iri(RDF.TYPE), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                        .add(new TTNode()
                                                                                .set(iri(OWL.SOME_VALUES_FROM, "someValuesFrom"), iri("http://snomed.info/sct#127954009", "Skeletal muscle structure (body structure)"))
                                                                                .set(iri(OWL.ON_PROPERTY, "onProperty"), iri("http://snomed.info/sct#363698007", "Finding site (attribute)"))
                                                                                .set(iri(RDF.TYPE, "type"), iri("http://www.w3.org/2002/07/owl#Restriction", "Restriction"))
                                                                        )
                                                                        .add(new TTNode()
