...
public class QueryGenHelper {
  ...
  public static String getEntitySource(String entityIri) {
    switch (entityIri) {
      case "http://endhealth.info/im#Person":
        return "person";
      case "http://endhealth.info/im#PersonDetails":
        return "person";
      case "http://endhealth.info/im#GPRegistration":
        return "registration_status_history";
      case "http://endhealth.info/im#PatientRegistration":
        return "registration_status_history";
      case "http://endhealth.info/im#Event":
        return "observation";
      default:
  ...
  public static String getField(Table table, String propertyIri, boolean withPrefix) {
    ...
    if ("http://endhealth.info/im#GPRegistration".equals(entityIri) || "http://endhealth.info/im#PatientRegistration".equals(entityIri)) {
      switch (propertyIri) {
        case "http://endhealth.info/im#isSubjectOf":
          return prefix + "person_id";
        case "http://endhealth.info/im#patientType":
          return prefix + "registration_status_concept_id";
        case "http://endhealth.info/im#effectiveDate":
          return prefix + "start_date";
        case "http://endhealth.info/im#endDate":
      ...
      switch (propertyIri) {
        case "http://endhealth.info/im#age":
          return "TIMESTAMPDIFF(YEAR, " + prefix + "date_of_birth, $ReferenceDate)";
        case "http://endhealth.info/im#isSubjectOf":
          return prefix + "id";
        default:
      ...
      switch (propertyIri) {
        case "http://endhealth.info/im#isSubjectOf":
          return prefix + "person_id";
        case "http://endhealth.info/im#concept":
          return prefix + "non_core_concept_id";
        case "http://endhealth.info/im#effectiveDate":
          return prefix + "clinical_effective_date";
        default:
          throw new IllegalArgumentException("Unknown entity property [" + entityIri + "].[" + propertyIri + "]");
      }
    }
  ...
  public static String getValue(TTIriRef i) {
    ...
    String iri = i.getIri();
    switch (iri) {
      case "http://endhealth.info/im#2751000252106":
        return "1335286";
      case "urn:uuid:db167604-ca0a-4922-9fab-f6d6d514c065":
        return "1335286";
      case "urn:uuid:837c474c-f6af-4a05-83ad-7c4ee7557e11":
        return "1082811";
      case "urn:uuid:8ab86afb-94e0-45fc-9875-3d16705cf41c":
        return "1057547";
      default:
