...
public class QueryController {
  ...
  @GetMapping("/public/returnType")
  @Operation(summary = "get the return type of the query")
  public TTIriRef getReturnType(@RequestParam(name = "queryIri") String queryIri) throws IOException {
    try (MetricsTimer t = MetricsHelper.recordTime("API.Query.GetQuery.POST")) {
      LOG.debug("getReturnType");
      return queryService.getReturnType(queryIri);
    }
  }
