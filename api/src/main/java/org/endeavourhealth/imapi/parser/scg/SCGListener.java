...
public interface SCGListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SCGParser#booleanvalue}.
	 * @param ctx the parse tree
	 */
	void enterBooleanvalue(SCGParser.BooleanvalueContext ctx);
	/**
	 * Exit a parse tree produced by {@link SCGParser#booleanvalue}.
	 * @param ctx the parse tree
	 */
	void exitBooleanvalue(SCGParser.BooleanvalueContext ctx);
	/**
	 * Enter a parse tree produced by {@link SCGParser#true_1}.
	 * @param ctx the parse tree
	 */
	void enterTrue_1(SCGParser.True_1Context ctx);
	/**
	 * Exit a parse tree produced by {@link SCGParser#true_1}.
	 * @param ctx the parse tree
	 */
	void exitTrue_1(SCGParser.True_1Context ctx);
	/**
	 * Enter a parse tree produced by {@link SCGParser#false_1}.
	 * @param ctx the parse tree
	 */
	void enterFalse_1(SCGParser.False_1Context ctx);
	/**
	 * Exit a parse tree produced by {@link SCGParser#false_1}.
	 * @param ctx the parse tree
	 */
	void exitFalse_1(SCGParser.False_1Context ctx);
	/**
