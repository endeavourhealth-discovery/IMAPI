      ...
      try (TupleQueryResult rs= qry.evaluate()){
        ...
        while (rs.hasNext()){
          ...
          if (bs.getValue("predicate")!=null) {
            ...
            if (object.isIRI()){
              entity.addObject(iri(predicate),iri(object.stringValue()).setName(bs.getValue("objectLabel").stringValue()));
            }
              ...
              if (bs.getValue("subPredicate")!=null){
                ...
                if (subObject.isIRI()){
                  blank.addObject(iri(subPredicate),iri(subObject.stringValue()).setName(bs.getValue("subObjectLabel").stringValue()));
                }
                else   blank.addObject(iri(subPredicate),TTLiteral.literal(subObject.stringValue()));
              }
            }
            else
              entity.addObject(iri(predicate),TTLiteral.literal(object.stringValue()));
          }
