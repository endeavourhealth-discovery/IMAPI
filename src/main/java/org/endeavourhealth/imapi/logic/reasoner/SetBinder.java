...
public class SetBinder {
  ...
  public void bindSets(GraphVocab insertGraph) {
  ...
  private Set<String> getSets() {
    ...
    try (IMDB conn = IMDB.getConnection()) {
      ...
      qry.setBinding("rdfType", EnumUtils.asDbIri(RdfVocab.TYPE));
      qry.setBinding("imConceptSet", EnumUtils.asDbIri(ImVocab.CONCEPT_SET));
      qry.setBinding("imValueSet", EnumUtils.asDbIri(ImVocab.VALUE_SET));
  ...
  public void bindSet(String iri, GraphVocab insertGraph) {
    ...
    if (!members.isEmpty()) {
      ...
      Set<TTNodeJava> dataModels = setRepository.getBindingsForConcept(memberIris);
