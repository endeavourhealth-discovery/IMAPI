...
public class IMLLexer extends Lexer {
	...
	public static final int
		...
		IDENTIFIER=33, NUMBER=34, WS=35, COMMENT=36, BLOCK_COMMENT=37;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "DEFINE", "AS", "MATCH", "FROM", "EITHER", "OR", "AND", "EXCLUDE", 
			...
			"IDENTIFIER", "NUMBER", "WS", "COMMENT", "BLOCK_COMMENT", "A", "B", "C", 
