...
class TTToStringTest {
    ...
    void bundleToString() throws Exception {
        String expected = "subClassOf : \n" +
                "Combination of : \n" +
                "  <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23128084001\">Duane's syndrome, type 3</a>\n" +
                "  <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23298382003\">Scoliosis deformity of spine</a>\n" +
                "  <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%2382354003\">Multiple system malformation syndrome</a>\n" +
                "  <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%2385995004\">Autosomal recessive hereditary disorder</a>\n" +
                "  ( With a value : \n" +
                "    Combination of : \n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%2331739005\">Lateral abnormal curvature</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23116676008\">Associated morphology</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23289959001\">Musculoskeletal structure of spine</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23363698007\">Finding site</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23308490002\">Pathological developmental process</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23370135005\">Pathological process</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "    On property : <a href=\"" + "/#/concept/http:%2F%2Fendhealth.info%2Fim%23roleGroup\">role group</a>\n" +
                "    type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "  ( With a value : \n" +
                "    Combination of : \n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%2349755003\">Morphologically abnormal structure</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23116676008\">Associated morphology</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23255399007\">Congenital</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23246454002\">Occurrence</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23127954009\">Skeletal muscle structure</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23363698007\">Finding site</a>\n" +
                "        type : <a href=\"" + "/#/concept/http:%2F%2Fwww.w3.org%2F2002%2F07%2Fowl%23Restriction\">Restriction</a> )\n" +
                "      ( With a value : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23308490002\">Pathological developmental process</a>\n" +
                "        On property : <a href=\"" + "/#/concept/http:%2F%2Fsnomed.info%2Fsct%23370135005\">Pathological process</a>\n" +
