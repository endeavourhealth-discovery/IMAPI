...
public class TTToOWLEL {
    ...
    for (Map.Entry<TTIriRef, TTArray> entry : predicates.entrySet()) {
      if (entry.getKey().equals(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfsVocab.SUBCLASS_OF))) {
        if (!entity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfVocab.PROPERTY)))
          ...
          addSubPropertyOf(iri, TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.OBJECT_PROPERTY), entry.getValue());
      } else if (entry.getKey().equals(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.EQUIVALENT_CLASS))) {
        addEquivalentClasses(iri, entry.getValue());
      } else if (entry.getKey().equals(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfsVocab.SUB_PROPERTY_OF))) {
        addSubPropertyOf(iri, TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.OBJECT_PROPERTY), entry.getValue());
  ...
  private OWLClassExpression getOPERestrictionAsOWlClassExpression(TTValue cex) {
    ...
    if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_PROPERTY)) != null) {
      ...
      IRI prop = getIri(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.INVERSE_OF)).asIriRef());
      owlOpe = dataFactory
        .getOWLObjectInverseOf(
          dataFactory.getOWLObjectProperty(prop));
    }
    if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ALL_VALUES_FROM)) != null) {
      return dataFactory.getOWLObjectAllValuesFrom(
        owlOpe,
        getOWLClassExpression(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ALL_VALUES_FROM)).asValue())
      );
    } else if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.SOME_VALUES_FROM)) != null) {
      return dataFactory.getOWLObjectAllValuesFrom(
        owlOpe,
        getOWLClassExpression(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.SOME_VALUES_FROM)).asValue())
      );
    } else if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.MIN_CARDINALITY)) != null) {
      return dataFactory.getOWLObjectSomeValuesFrom(
        owlOpe,
        getOWLClassExpression(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_CLASS)).asValue())
      );
    } else if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.MAX_CARDINALITY)) != null) {
      return dataFactory.getOWLObjectSomeValuesFrom(
        owlOpe,
        getOWLClassExpression(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_CLASS)).asValue())
      );
    } else if (exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_CLASS)) != null) {
      return dataFactory.getOWLObjectSomeValuesFrom(
        owlOpe,
        getOWLClassExpression(exp.get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_CLASS)).asValue())
      );
  ...
  public OWLClassExpression getOWLClassExpression(TTValue cex) {
    if (cex.isIriRef()) {
      ...
      if (cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.INTERSECTION_OF)) != null) {
        return dataFactory.getOWLObjectIntersectionOf(
          cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.INTERSECTION_OF))
            .stream()
            .map(this::getOWLClassExpression)
            .collect(Collectors.toSet()));
        //
      } else if (cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.UNION_OF)) != null) {
        return dataFactory.getOWLObjectUnionOf(
          cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.UNION_OF))
            .stream()
            .map(this::getOWLClassExpression)
            .collect(Collectors.toSet()));
      } else if (cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ON_PROPERTY)) != null) {
        return getOPERestrictionAsOWlClassExpression(cex);
      } else if (cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ONE_OF)) != null) {
        return getOneOfAsOWLClassExpression(cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ONE_OF)));
      } else if (cex.asNode().get(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.COMPLEMENT_OF)) != null) {
  ...
  private void addDeclaration(TTEntity ttEntity) {
    ...
    OWLEntity entity;
    if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.CLASS)))
      entity = dataFactory.getOWLEntity(EntityType.CLASS, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), ImVocab.CONCEPT)))
      entity = dataFactory.getOWLEntity(EntityType.CLASS, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.OBJECT_PROPERTY)))
      entity = dataFactory.getOWLEntity(EntityType.OBJECT_PROPERTY, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.DATATYPE_PROPERTY)))
      entity = dataFactory.getOWLEntity(EntityType.OBJECT_PROPERTY, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), RdfVocab.PROPERTY)))
      entity = dataFactory.getOWLEntity(EntityType.OBJECT_PROPERTY, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.ANNOTATION_PROPERTY)))
      entity = dataFactory.getOWLEntity(EntityType.ANNOTATION_PROPERTY, iri);
    else if (ttEntity.isType(TTIriRefExtensionsKt.iri(new TTIriRef(), OwlVocab.NAMED_INDIVIDUAL)))
