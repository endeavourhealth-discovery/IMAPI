...
---
## Input:
Given the the JSON files in `Z:\Data\QOF` which contain boolean queries, generate transformation
code that converts them into an IMQ format, as defined by the classes in the `model\api` directory.
